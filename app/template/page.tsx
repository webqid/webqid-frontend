...
/**
 * Template page for creating new pages with consistent styling.
 */
export default function TemplatePage(): React.JSX.Element {
  return (
    <div className="container py-28 md:py-36 text-neutral-300 font-[geist-sans] antialiased px-4">
      {/* ─── Intro ───────────────────────────────────────────── */}
      <section aria-labelledby="template-title" className="text-center space-y-6">
        <motion.h1
          id="template-title"
      ...
      <span
        aria-hidden="true"
        className="text-[192px] font-bold tracking-tight after:content-['.'] after:-ml-2 after:text-teal-500 after:font-[geist-mono]"
      >
        w
      </span>
